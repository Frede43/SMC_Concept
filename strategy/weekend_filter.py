...
class WeekendFilter:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        logger.info(f"WeekendFilter initialized - Enabled: {self.enabled}, "
    ...
    def can_trade(self) -> Tuple[bool, str]:
        ...
        local_time = self._get_local_time()
        day_name = ['Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi', 'Dimanche'][local_time.weekday()]
    ...
    def should_close_positions(self) -> Tuple[bool, str]:
        ...
        if local_time.weekday() == 4 and local_time.hour >= self.friday_close_hour:
            return True, f"🔒 Vendredi {local_time.strftime('%H:%M')} - Fermeture positions avant week-end"
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'day': ['Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi', 'Dimanche'][local_time.weekday()],
            'can_trade': can_trade,
